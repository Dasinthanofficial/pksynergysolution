...
const InquiryForm = ({ companyName }) => {
  ...
  return (
    <div className="min-w-0 rounded-[2rem] border border-white/60 bg-white/95 p-6 shadow-[0_30px_90px_rgba(12,20,16,0.08)] backdrop-blur sm:p-8 lg:p-10">
      <div className="mb-6">
      ...
      <form onSubmit={onSubmit} className="mt-8 space-y-5">
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-2xl bg-brand px-6 py-4 text-sm font-semibold text-white shadow-[0_18px_35px_rgba(13,74,51,0.22)] transition duration-300 hover:-translate-y-0.5 hover:bg-brand-dark disabled:opacity-70 disabled:hover:translate-y-0"
        >
